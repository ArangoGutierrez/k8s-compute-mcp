...
- [ ] Kubernetes Client
- [ ] Tool Implementation (submit_*, check_*, read_*)
- [ ] Manifest Generation (MPIJob, JobSet, Job)
- [ ] Helm Chart
- [ ] Build / Container
- [ ] Documentation
...
```bash
# Example:
# 1. Build server: go build ./cmd/server
# 2. Run with: ./server
# 3. Test tool: echo '{"method":"tools/call"...}' | ./server
```

**Test Environment:**
<!-- If testing with real cluster, provide details -->

- Kubernetes Version: 
- MPI Operator Version: 
- JobSet Controller Version: 
- Kueue Version: 
